...
export const normalizeInferenceTaskInfo = (taskInfo = {}) => ({
  ...
  remoteHost: String(taskInfo.remoteHost ?? '127.0.0.1').trim(),
  remotePort: numberOrDefault(taskInfo.remotePort ?? 5555, 5555),
  remoteTimeoutMs: numberOrDefault(taskInfo.remoteTimeoutMs ?? 300000, 300000),
