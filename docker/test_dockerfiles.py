...
def test_interactive_bashrc_includes_simple_ros_zenoh_block():
    dockerfiles = (
        ...
        REPO_ROOT / "cyclo_brain" / "policy" / "rldx" / "Dockerfile.arm64",
...
def test_ros_zenoh_runtime_env_file_is_not_referenced_by_images_or_s6():
    paths = (
        ...
        REPO_ROOT / "cyclo_brain" / "policy" / "rldx" / "s6-services" / "main-runtime" / "run",
        REPO_ROOT / "cyclo_brain" / "policy" / "rldx" / "s6-services" / "engine-process" / "run",
    )
